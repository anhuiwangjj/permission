...
import com.stone.manage.admin.security.GrantedAuthorityImpl;
...
public class JwtTokenUtils implements Serializable {
     ...
     * 秘钥
     */
    private static final String SECRET = "stone";
        ...
        if (StringUtils.isNotBlank(token)) {
            if (Objects.isNull(SecurityUtils.getAuthentication())){
                ...
                if (validateToken(token,SecurityUtils.getUserName())){
                    //上下文中authentication非空，且令牌合法，直接返回当前登录认证信息
    ...
    public static Boolean validateToken(String token,String username){
        ...
        return (Objects.equals(userName,username) && !beenExpired(token));
    }
     ...
     * @return
     */
    public static Boolean beenExpired(String token){
        Claims claims = getClaimsFromToken(token);
